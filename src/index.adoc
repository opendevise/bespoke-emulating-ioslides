:title-opts: slice
= A Demonstration of the{zwsp} ioslides Presentation Engine: As Emulated by Bespoke.js
Author Name
:position: Job Title
...
image::mountains.jpg[Mountains,1100,700,role=cover canvas,credit=unsplash.com/photos/PKVcQXEcfLU]
[.credit.light]
...
[.inverse.subject]
== !
image::google-developers-logo-inverse.png[Google Developers,422,96,role=logo crux]
